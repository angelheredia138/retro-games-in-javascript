...
const Pong = () => {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      if (ballVelocityX > 0 && ballX > canvasWidth / 2) { // Only adjust when ball is moving towards AI
  ...
  return (
    <div className="pong-container">
      ...
      <h2>Pong</h2>
      <h3>Game ends at 20 points (if the game starts lagging, try refreshing!)</h3>
      <h4>Score: Human {humanScore} - AI {aiScore}</h4>
